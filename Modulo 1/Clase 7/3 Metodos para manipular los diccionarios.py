...
#! al igual que las listas, los diccionarios en python tienen varios métodos incorporados que facilitan la manipulación de sus elementos.
...
#? 4. get(): permite acceder al valor asociado a una clave, devolviendo None si la clave no existe 
#? (o un valor predeterminado si se especifica).
print("-"*30)
...
#? update(): permite actualizar el diccionario con pares clave-valor de otro diccionario o con pares clave-valor especificados.
...
#! estos métodos son útiles para manipular y gestionar los datos almacenados en diccionarios de manera eficiente.
#! los diccionarios se usan comúnmente para representar datos estructurados, como registros de personas, configuraciones, etc.