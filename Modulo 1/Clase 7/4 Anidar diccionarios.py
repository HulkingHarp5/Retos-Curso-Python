...
#? podemos tener un diccionario dentro de otro diccionario, lo que nos permite organizar la información de manera jerárquica.
...
print(base_de_datos)
#? para acceder a los datos anidados, usamos la clave del diccionario principal seguida de la clave del diccionario anidado.
print("Nombre del user_103:", base_de_datos["user_103"]["nombre"])
#? para modificar un valor en un diccionario anidado, accedemos a él de la misma manera y asignamos un nuevo valor.
base_de_datos["user_104"]["edad"] = 23
print("Edad actualizada del user_104:", base_de_datos["user_104"]["edad"])
#? para agregar un nuevo par clave-valor a un diccionario anidado, accedemos al diccionario y asignamos el nuevo par.
...
for user_id, user_info in base_de_datos.items(): #! se usa items() para obtener clave y valor, donde el valor es otro diccionario
