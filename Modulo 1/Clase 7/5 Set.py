...
#set
#el set es otra estructura de datos en python que permite almacenar una colección de elementos únicos y desordenados.
#! a diferencia de las listas y tuplas, los sets no permiten elementos duplicados y no mantienen un orden específico.
#? los sets se definen utilizando llaves {} o la función set().
#? los elementos de un set deben ser inmutables (como cadenas, números o tuplas), pero el set en sí es mutable.
...
#! permite realizar operaciones matemáticas como unión, intersección y diferencia de conjuntos.
#! es mas rapido para verificar la pertenencia de un elemento en comparación con listas o tuplas.
print("-"*30)
...
#? 6. difference(): devuelve un nuevo set con los elementos que están en el primer set pero no en el segundo.
...
print("-"*30)
#! los sets son útiles cuando se necesita almacenar una colección de elementos únicos y realizar operaciones de conjuntos.
...
#! Para eliminar duplicados, para comparar dos listas y ver qué tienen en común o qué tienen de diferente.