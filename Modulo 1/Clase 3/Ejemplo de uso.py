#Ejemplo practico de uso de listas
# --- 1. Inicio: Creando la lista (append) ---
equipo_pokemon = []
print("--- ¡COMIENZA TU AVENTURA! ---")
print(f"Tu equipo inicial: {equipo_pokemon}")

# El usuario añade sus 3 Pokémon iniciales de forma secuencial
...
segundo_pokemon = input("2. Elige tu segundo Pokémon: ")
equipo_pokemon.append(segundo_pokemon)
print(f"-> Equipo actual: {equipo_pokemon}")

tercer_pokemon = input("3. Elige un tercer Pokémon: ")
...
pokemon_sorpresa = input("¿Qué Pokémon apareció de repente?: ")
# Insertamos el nuevo Pokémon en la primera posición (índice 0)
...
# 'pop()' elimina y nos devuelve el último elemento. Es seguro porque sabemos que la lista no está vacía.
...
# 'remove()' elimina un elemento por su nombre. Lo usamos con un nombre que sabemos que existe.
...
# 'index()' lo usamos con un valor que sabemos que existe (el primer Pokémon que el usuario añadió).
...
print(f"Equipo en orden alfabético inverso: {equipo_pokemon}")
